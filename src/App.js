      ...
      {isSidebarOpen && (
        <>
            ...
            <ul className="nav flex-column w-100 text-center">
              ...
              <li className="nav-item">
                <Link to="/meaning-matcher" className="nav-link">Grammar Games</Link>
              </li>
              <li className="nav-item">
                <Link to="/paragraph-parler" className="nav-link">Paragraph Parler</Link>
              </li>
              <li className="nav-item">
            ...
            <div className="week-selector my-3">
              <label htmlFor="week-select" className="week-label">Select Session:</label>
              <select id="week-select" onChange={handleWeekChange} value={selectedWeek} className="week-dropdown">
                <option value="week1">Session 1 & 2</option>
                <option value="week2">Session 3 & 4</option>
                <option value="week3">Session 5 & 6</option>
                <option value="week4">Session 7 & 8</option>
          ...
          <Routes>
            {!user ? (
              ...
              <>
                ...
                <Route path="/paragraph-parler" element={<ProtectedRoute user={user}><ParagraphParler selectedWeek={selectedWeek}/></ProtectedRoute>} />
