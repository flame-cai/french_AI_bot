...
const VocabVault = ({selectedWeek}) => {
  ...
  const fetchWords = async () => {
    try {
      const response = await axios.post('https://asia-south1-ppt-tts.cloudfunctions.net/fr-lang-backend/vocab',{week: selectedWeek, queue: wordQueue},{
        headers: {
  ...
  return (
    <div class="chat-container">
      ...
      <h4>Here are some new French words to learn:</h4><hr/><br/>
      <ul>
